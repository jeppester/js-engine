 ...
 */
Engine.Camera = function (captureRegion, projectionRegion, room) {
  if (!captureRegion instanceof Math.Rectangle) {throw new Error('Argument captureRegion should be of type: Rectangle'); } //dev
  if (!projectionRegion instanceof Math.Rectangle) {throw new Error('Argument projectionRegion should be of type: Rectangle'); } //dev
