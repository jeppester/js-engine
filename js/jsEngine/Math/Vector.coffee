...
###
  ...
  ###
  getDistance: (object) ->
    return object.copy().subtract(this).getLength()  if object instanceof Math.Vector
    ...
    throw new Error("Argument object should be of type: Vector, Line, Circle, Rectangle or Polygon")return #dev
