...
new Class('CustomLoop', {
	 ...
	 * @param {function} [maskFunction=function(){}] A function that will be run before each execution, if the function returns true the execution procedes as planned, if not, the execution will not be run
	 */
	 ...
	 * 
	 * @param {function} func The function to detach from the loop
	 * @return {Array.<function>} An array of detached functions
	 */
	 ...
	 * @return {boolean|Array.<function>} False if no functions has been unscheduled, otherwise an array containing the unscheduled functions
	 */
	 ...
	 * 
	 * @return {Array.<function>} An array of all the unscheduled functions
	 */
