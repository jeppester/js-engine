new Class('Collidable', [Sprite], {
	...
	maskCollidesWith: function (objects, getCollisionPosition) {
		if (objects === undefined) {throw new Error('Missing argument: objects'); }
		var canvas, mask, ctx, roomPos, obj, bitmap, i, data, length, pixel, pxArr, x, y, avX, avY, retVector;
     ...
     * @param {Vector} cameraOffset A vector defining the offset with which to draw the bounding box
	 */
