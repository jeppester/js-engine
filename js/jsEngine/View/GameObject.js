 ...
 *                                        </code>
 */
View.GameObject = function (source, x, y, direction, additionalProperties) {
...
View.GameObject.prototype = Object.create(View.Collidable.prototype);

View.GameObject.prototype.import(/** @lends View.GameObject.prototype */ {
	/**
